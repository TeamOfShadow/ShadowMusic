from ShadowMusic import BOT_USERNAME, LOG_GROUP_ID, app
from ShadowMusic.Database import blacklisted_chats, is_gbanned_user, is_on_off
    ...
    async def wrapper(_, message):
        ...
        if message.chat.id in blacklisted_chats_list:
            await message.reply_text(
                f"**Blacklisted Chat**\n\nYour chat has been blacklisted by Sudo Users.Ask any __SUDO USER__ to whitelist.\nCheck Sudo Users List [From Here](https://t.me/{BOT_USERNAME}?start=sudolist)", disable_web_page_preview=True
            )
