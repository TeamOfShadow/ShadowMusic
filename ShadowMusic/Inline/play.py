...
def search_markup(
    ...
    buttons = [
        [
            InlineKeyboardButton(
                text="1️⃣", callback_data=f"ShadowMusic {ID1}|{duration1}|{user_id}"
            ),
            InlineKeyboardButton(
                text="2️⃣", callback_data=f"ShadowMusic {ID2}|{duration2}|{user_id}"
            ),
            InlineKeyboardButton(
                text="3️⃣", callback_data=f"ShadowMusic {ID3}|{duration3}|{user_id}"
            ),
        ],
        [
            InlineKeyboardButton(
                text="4️⃣", callback_data=f"ShadowMusic {ID4}|{duration4}|{user_id}"
            ),
            InlineKeyboardButton(
                text="5️⃣", callback_data=f"ShadowMusic {ID5}|{duration5}|{user_id}"
            ),
        ],
        [
            InlineKeyboardButton(
