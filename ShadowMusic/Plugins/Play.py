...
from ShadowMusic import (BOT_USERNAME, DURATION_LIMIT, DURATION_LIMIT_MIN,
...
from ShadowMusic.Decorators.checker import checker
from ShadowMusic.Decorators.permission import PermissionCheck
from ShadowMusic.Inline import (playlist_markup, search_markup, search_markup2,
                                url_markup, url_markup2)
from ShadowMusic.Utilities.changers import seconds_to_min, time_to_seconds
from ShadowMusic.Utilities.chat import specialfont_to_normal
from ShadowMusic.Utilities.stream import start_stream, start_stream_audio
from ShadowMusic.Utilities.theme import check_theme
from ShadowMusic.Utilities.thumbnails import gen_thumb
from ShadowMusic.Utilities.url import get_url
from ShadowMusic.Utilities.youtube import (get_yt_info_id, get_yt_info_query,
...
@app.on_callback_query(filters.regex(pattern=r"ShadowMusic"))
...
async def search_query_more(_, CallbackQuery):
    ...
    med = InputMediaPhoto(
        media="https://telegra.ph/file/4c39fbb88932761913fff.png",
        caption=(
