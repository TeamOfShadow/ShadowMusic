...
async def gen_thumb(thumbnail, title, userid, theme, ctitle):
    ...
    font = ImageFont.truetype("Utils/finalfont.ttf", 25)
    font2 = ImageFont.truetype("Utils/finalfont.ttf", 76)     
    draw.text((20, 538), f"{title[:20]}...", fill= "white", stroke_width = 1, stroke_fill="white", font=font2)
    draw.text((20, 640), f"Playing on: {ctitle[:45]}...", fill="white", stroke_width = 1, stroke_fill="white" ,font=font)
