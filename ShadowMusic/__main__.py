...
async def initiate_bot():
    ...
    try:
        await app.send_message(
            LOG_GROUP_ID,
            "<b>Congrats!! Shadow Music has started successfully!</b>",
        )
    except Exception as e:
        print(
...
@app.on_callback_query(filters.regex("deshadeeththisarana"))
async def deshadeeththisarana(_, CallbackQuery):
